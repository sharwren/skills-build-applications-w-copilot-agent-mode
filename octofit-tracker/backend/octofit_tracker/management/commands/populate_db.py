...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            logger.info('Users created: %s', User.objects.all())
            ...
            logger.info('Teams created: %s', Team.objects.all())
            ...
            logger.info('Activities created: %s', Activity.objects.all())
            ...
            logger.info('Leaderboard entries created: %s', Leaderboard.objects.all())
            ...
            logger.info('Workouts created: %s', Workout.objects.all())

            self.stdout.write(self.style.SUCCESS('Successfully populated the database with test data.'))
        except Exception as e:
            logger.error('Error populating database: %s', e)
            raise